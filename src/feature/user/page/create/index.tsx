...
const validator = yup.object({
  ...
  gender: yup.string()
    .oneOf(['1', '2'], 'Vui lòng chọn giới tính')
...
export default function UserCreate() {
  ...
  // const { setValue, watch, formState: { errors } } = useFormContext(); // hoặc từ useForm()
  ...
  return (
    <div className="min-h-screen max_w_414px m-auto bg-white w-full h-full pt-[15px] md:px-[15px] pb-[6px]">
      <Header title={"Thêm mới user"} backHref={getManagementPath('user')}/>
      ...
      <form onSubmit={handleSubmit(onSubmit)} noValidate className={"mt-4"}>
        ...
        <div className="form_group mb-2">
          ...
          {/*<InputErrorMessage message="Vui long chon" />*/}
        </div>
